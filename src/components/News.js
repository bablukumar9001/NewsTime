...
import InfiniteScroll from 'react-infinite-scroll-component'
 ...
 const News =(props)=> {
    ...
    const updateNews =async () =>{
      ...
      useEffect(()=>{
    document.title = `${capitalizeFirstLetter( props.category)} -newsDuniyaa`
        updateNews()
    ...
    const fetchMoreData = async () => {
        ...
        return (
            ...
            <h1 className='text-center' style={{"marginTop":"85px"}}>NewsTime - top {capitalizeFirstLetter( props.category)} Headlines </h1>
                {loading && <Loading />}
